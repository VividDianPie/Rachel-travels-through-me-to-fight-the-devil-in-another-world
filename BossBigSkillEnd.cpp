...
void CBossBigSkillEnd::Init()
{
	...
	m_Animation->SetBmp("BOSS大招一段17", 7, -44, 2);
	m_Animation->SetBmp("BOSS大招一段16", 8, -131, 2);
	m_Animation->SetBmp("BOSS大招一段15", 25, -150, 2);
	m_Animation->SetBmp("BOSS大招一段14", -6, -216, 2);
	m_Animation->SetBmp("BOSS大招一段13", 13, -261, 2);
	m_Animation->SetBmp("BOSS大招一段12", 20, -278, 2);
	m_Animation->SetBmp("BOSS大招一段11", 16, -247, 2);
	m_Animation->SetBmp("BOSS大招一段10", 16, -214, 2);
	m_Animation->SetBmp("BOSS大招一段9", 17, -202, 2);
	m_Animation->SetBmp("BOSS大招一段8", 17, -222, 2);
	m_Animation->SetBmp("BOSS大招一段7", 18, -216, 2);
	m_Animation->SetBmp("BOSS大招一段6", 8, -238, 2);
	m_Animation->SetBmp("BOSS大招一段5", 2, -245, 2);
	m_Animation->SetBmp("BOSS大招一段4", 2, -262, 2);
	m_Animation->SetBmp("BOSS大招一段3", -14, -270, 2);
	m_Animation->SetBmp("BOSS大招一段2", 9, -203, 2);
	m_Animation->SetBmp("BOSS大招一段1", 10, -189, 2);
	m_Animation->SetBmp("BOSS大招一段0", 4, -166, 2);
	m_NextAct = BOSS站;
}
